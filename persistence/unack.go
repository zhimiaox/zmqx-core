...
import "github.com/zhimiaox/zmqx-core/packets"

// Unack Store represents a unack store for one client.
// Unack store is used to persist the unacknowledged qos2 messages.
type Unack interface {
